...
# Configuration
class Config:
    MODEL_PATH = "E:\\AI Project PUSSGRC\\FinalvisionMateAi\\pages\\models\\best.pt"
    ONNX_MODEL_PATH = "E:\\AI Project PUSSGRC\\FinalvisionMateAi\\pages\\models\\fire_detection_best.onnx"
